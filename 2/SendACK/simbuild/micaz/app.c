...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7c0b458, const void *arg_0xb7c0b5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7bbc8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a66840), 
int (*key_eq_fn)(void *arg_0xb7a66c88, void *arg_0xb7a66e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79359b8, int arg_0xb7935b10);
static double RandomUniform(void );
...
typedef TMilli sendAckC$requestTimer$precision_tag;
...
static void sendAckC$requestTimer$fired(void );
...
message_t * msg);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$requestTimer$startPeriodic(uint32_t dt);
# 28 "sendAckC.nc"
uint8_t sendAckC$counter[1000];


bool sendAckC$rec_id[1000];
...
static inline void sendAckC$requestTimer$fired(void );
#line 143
...
#line 179
{
  ...
  if (len != sizeof(my_msg_t )) {
...

    {
      ...
      sim_log_debug(158U, "radio_rec", "Received packet at time %s\n", sim_time_string());
      sim_log_debug(159U, "radio_pack", " Payload length %hhu \n", sendAckC$Packet$payloadLength(buf));
      sim_log_debug(160U, "radio_pack", ">>>Pack \n");
      sim_log_debug_clear(161U, "radio_pack", "\t\t Payload Received\n");
      sim_log_debug_clear(162U, "radio_pack", "\t\t type: %hhu \n ", __nesc_ntoh_uint16(mess->type.nxdata));

      if (__nesc_ntoh_uint16(mess->type.nxdata) == 1 && TOS_NODE_ID == 2) {

          sim_log_debug_clear(163U, "radio_pack", "\t\t data: %hhu \n", __nesc_ntoh_uint16(mess->data.nxdata));
...

        {
          ...
          sim_log_debug_clear(164U, "radio_pack", "\t\t data: %hhu \n", __nesc_ntoh_uint16(mess->data.nxdata));
        }
  ...
  {
    sim_log_error(165U, "radio_rec", "Receiving error \n");
  }
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76d9ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76d9ac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76d9ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76d6178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76d6178, msg, payload, len);
#line 78
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$requestTimer$startPeriodic(uint32_t dt){
#line 64
...
#line 101
{
  ...
  if (err == SUCCESS) {
      ...
      sim_log_debug(155U, "radio", "Radio on!\n");

      if (TOS_NODE_ID == 1) {

          sendAckC$requestTimer$startPeriodic(1000);
        }
    }
  else 
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76d9108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76d9108, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73dca98, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73dca98) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73dca98, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7891650){
#line 75
  switch (arg_0xb7891650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7891650);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73d9498, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73d9498, addr, msg, len);
#line 80
...
#line 41
{
  ...
  __nesc_hton_uint16(rcm->counter.nxdata, sendAckC$counter[sim_node()]);
  __nesc_hton_uint16(rcm->type.nxdata, 1);
  ...
  if (sendAckC$AMSend$send(2, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug(148U, "radio_send", "Packet passed to lower layer successfully!\n");
      sim_log_debug(149U, "radio_pack", ">>>Pack\n \t Payload length %hhu \n", sendAckC$Packet$payloadLength(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(150U, "radio_pack", "\t Payload Sent\n");
      sim_log_debug_clear(151U, "radio_pack", "\t\t type: %hhu \n ", __nesc_ntoh_uint16(rcm->type.nxdata));
      sim_log_debug_clear(152U, "radio_pack", "\t\t counter: %hhu \n", __nesc_ntoh_uint16(rcm->counter.nxdata));
    }
}
...
#line 125
{
  ...
  if (TOS_NODE_ID == 1 && !sendAckC$rec_id[sim_node()]) {
...
#line 231
{
  ...
  sim_log_debug(166U, "role", "fake read done %f\n", data);
  ...
  __nesc_hton_uint16(resp->counter.nxdata, sendAckC$counter[sim_node()]);
  __nesc_hton_uint16(resp->type.nxdata, 2);
  __nesc_hton_uint16(resp->data.nxdata, data);
  ...
  if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug_clear(170U, "radio_pack", "\t\t type: %hhu \n ", __nesc_ntoh_uint16(resp->type.nxdata));
      sim_log_debug_clear(171U, "radio_pack", "\t\t counter: %hhu \n", __nesc_ntoh_uint16(resp->counter.nxdata));
    }
}
...
#line 577
{
  sim_log_debug(198U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(197U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(194U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(195U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(187U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(177U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(182U, "HplAtm128Timer0AsyncP", "TIFR is %hhx\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x36]);
          sim_log_debug(183U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(184U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(189U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 92
{
  ...
  sim_log_debug(154U, "boot", "Application booted on node %u.\n", TOS_NODE_ID);
  sendAckC$SplitControl$start();
}
...
#line 285
  ...
  sim_log_debug(186U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(192U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 143
{
  ...
  if (&sendAckC$packet[sim_node()] == buf && sendAckC$PacketAcknowledgements$wasAcked(buf)) {

      if (TOS_NODE_ID == 1) {

          sendAckC$rec_id[sim_node()] = TRUE;

          sim_log_debug(156U, "Ack", "Ack correctly received!\n");
        }


      if (TOS_NODE_ID == 2) {

          sim_log_debug(157U, "Ack", "Node 2 ACK recevived!\n");
        }
    }
  else 
...
#line 101
      sim_log_debug(172U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(173U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(174U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(175U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(193U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(196U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(185U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  sendAckC$rec_id[__nesc_mote] = FALSE;
